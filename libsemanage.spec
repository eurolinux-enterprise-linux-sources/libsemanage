...
Patch3: libsemanage-RHEL6_7.patch
...
%changelog
* Mon Mar 16 2015 Petr Lautrbach <plautrba@redhat.com> 2.0.43-5.1
- Detect already enabled/disabled modules in semanage_direct_{enable,disable} functions
Resolves: rhbz#872700
- Fix sources to pass all tests
Rsolves: rhbz#591451
